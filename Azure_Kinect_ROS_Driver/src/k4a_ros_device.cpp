                                         ...
                                         ros::Time capture_time)
{
  ...
  marker_msg->header.frame_id = rgb_frame;
 ...
 //try transforming from depth_camera_link to rgb_camera_link by waiting for the transform upto 1 second
  ...
  //Output in RGB frame directly
  marker_msg->pose.position.x = pose_msg.position.x;
  marker_msg->pose.position.y = pose_msg.position.y;
  marker_msg->pose.position.z = pose_msg.position.z;
  marker_msg->pose.orientation.w = pose_msg.orientation.w;
  marker_msg->pose.orientation.x = pose_msg.orientation.x;
  marker_msg->pose.orientation.y = pose_msg.orientation.y;
  marker_msg->pose.orientation.z = pose_msg.orientation.z;
